        ...
        <div class="app-container dosen-container">
            ...
            <main class="app-body dosen-body">
                ...
                <section class="lecturer-hero-card">
                    ...
                    <p>
                        Kelola aktivitas akademik laboratorium dengan lebih rapi melalui jadwal penggunaan dan
                ...
                <section class="lecturer-layout">
                    <div class="lecturer-quick-panel">
                        ...
                        <p>
                            Fokus utama dosen adalah mengecek jadwal lab dan memverifikasi pengajuan peminjaman
                            mahasiswa.
                        </p>
                    </div>
